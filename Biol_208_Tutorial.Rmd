...
Looking at the QQ plots, we can see that the data may not normally distributed.
...
Another way to visualize this dataset is by creating a species accumulation curve. 
