...
We will be providing a walkthrough of general R skills including: package loading, data visualization using ggplot2, and data analysis. Additionally we will introduce several packages that can aid in investigation of specific 208 topics and questions. 
...
Before running any other tests or visual analyses of your data you should generate a hypothesis. In this example we will be testing the hypothesis that the longer sepal lengths will generate longer petal lengths. To test this we should first create subsets of the data for each species.
